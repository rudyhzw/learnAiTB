...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivProduct,
      @NonNull TextView tvPrice, @NonNull TextView tvSales, @NonNull TextView tvTitle) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((LinearLayout) rootView, ivProduct, tvPrice, tvSales, tvTitle);
    }
